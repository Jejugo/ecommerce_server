...
const stripeMethods = require('../helper/stripe')

const sendEmail = makeSendEmail({ nodemailer, google })
const registerCustomer = makeRegisterCustomer({ bcrypt, Customer, sendEmail, jwt, stripeMethods, builder })
...
const checkoutAction = makeCheckoutAction({ stripe, uuid, Customer_Stripe, stripeMethods, Customer })
